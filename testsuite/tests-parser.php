...
require_once(dirname(__FILE__) . '/tests/parser/issue78.php');
require_once(dirname(__FILE__) . '/tests/parser/issue80.php');
require_once(dirname(__FILE__) . '/tests/parser/issue82.php');
require_once(dirname(__FILE__) . '/tests/parser/issue87.php');
require_once(dirname(__FILE__) . '/tests/parser/issue90.php');
require_once(dirname(__FILE__) . '/tests/parser/issue91.php');
require_once(dirname(__FILE__) . '/tests/parser/issue93.php');
require_once(dirname(__FILE__) . '/tests/parser/issue94.php');
require_once(dirname(__FILE__) . '/tests/parser/issue95.php');
require_once(dirname(__FILE__) . '/tests/parser/issue97.php');
require_once(dirname(__FILE__) . '/tests/parser/issue98.php');
require_once(dirname(__FILE__) . '/tests/parser/issue102.php');
require_once(dirname(__FILE__) . '/tests/parser/left.php');
require_once(dirname(__FILE__) . '/tests/parser/manual.php');
